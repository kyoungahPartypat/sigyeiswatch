(function($) {
  ...
  $.fn.bsPhotoGallery = function(options) {
      ...
      function showModal(){
		  ...
		  var id = $(this).find('#imgId').attr('value');
		  ...
		  html += '<button type = "button" class = "btn btn-primary" onclick = "location.href=\'/photos/detail/' + id + '/download\'">다운로드</button>'
